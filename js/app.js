(() => {
    ...
    function initSliders() {
        if (document.querySelector(".spots-content__slider")) new core(".spots-content__slider", {
        ...
        if (document.querySelector(".content-editors__slider")) new core(".content-editors__slider", {
            ...
            speed: 800,
            pagination: {
                el: ".content-editors__swiper-pagination",
                clickable: true,
                type: "fraction"
            },
            navigation: {
                prevEl: ".content-editors__swiper-button-prev",
                nextEl: ".content-editors__swiper-button-next"
            },
            breakpoints: {
                320: {},
                768: {},
    ...
    function sortSlidesAlphabetically() {
        const slideWrapper = document.getElementById("editor-wrapper");
        ...
        const spollersClose = document.querySelectorAll("[data-spoller-close]");
        console.log(spollersClose.classList);
    }
    function sortSlidesReverseAlphabetically() {
        const slideWrapper = document.getElementById("editor-wrapper");
        const slides = Array.from(slideWrapper.children);
        slides.sort(((a, b) => {
            const nameA = a.getAttribute("data-name").toUpperCase();
    ...
    const alphaAscButton = document.getElementById("alpha_asc");
    alphaAscButton.addEventListener("click", (() => {
        sortSlidesAlphabetically();
        const spollersClose = document.querySelectorAll("[data-spoller-close]");
    ...
    const alphaDescButton = document.getElementById("alpha_desc");
    alphaDescButton.addEventListener("click", (() => {
        sortSlidesReverseAlphabetically();
        const spollersClose = document.querySelectorAll("[data-spoller-close]");
        spollersClose.forEach((spollerClose => {
            const spollersBlock = spollerClose.closest("[data-spollers]");
            if (spollersBlock.classList.contains("_spoller-init")) {
